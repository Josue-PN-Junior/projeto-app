...
public class AdapterListaHomeM extends RecyclerView.Adapter<AdapterListaHomeM.listaHomeViewHolder> {

    private final ArrayList<vagasHome> vagasLista;
    private final Context context;

    public AdapterListaHomeM(ArrayList<vagasHome> vagasLista, Context context) {
